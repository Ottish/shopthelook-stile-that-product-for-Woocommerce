...
if (!class_exists('Shop_The_Look_Style_It')) {
    class Shop_The_Look_Style_It {
            ...
            <div>
                <ul>
                    <?php foreach ($products as $product): ?>
                        <li>
                            <label>
                                <input type="checkbox" name="look_products[]" value="<?php echo esc_attr($product->get_id()); ?>" <?php checked(in_array($product->get_id(), $selected_products)); ?>>
        ...
        public function admin_page() {
            ...
            <div class="wrap">
                ...
                <a href="<?php echo esc_url(admin_url('edit.php?post_type=look')); ?>" class="button button-primary"><?php _e('Go to Looks', 'textdomain'); ?></a>
            </div>
            <?php
        }
    }
